...
import javax.swing.*;
 ...
 class tv32 extends JFrame implements ActionListener{	
	int price;
	...
	ImageIcon i1=new ImageIcon("s32.jpg");
	ImageIcon i2=new ImageIcon("stv32.jpg");
	ImageIcon i3=new ImageIcon("lg32.jpg");
	ImageIcon i4=new ImageIcon("lg43.jpg");
	
	l1=new JLabel("32 INCHES SAMSUNG");
	l2=new JLabel("Rs29000");
	l3=new JLabel("32 INCHES IGO");
	l4=new JLabel("RS.31000");
	l5=new JLabel("32 INCHES LG");
	l6=new JLabel("RS.28890");
	l7=new JLabel("32INCHES  PANASONIC");
